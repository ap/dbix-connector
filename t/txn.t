...
NOEXIT: {
    ...
    my $begin_work_meth = Hook::Guard->new( *DBIx::Connector::Driver::begin_work )->hook( sub { shift } );
    my $keyword;
    my $begin_work_meth = Hook::Guard->new( *DBIx::Connector::Driver::commit )->hook( sub {
